...
const createAcademicFaculty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_service_1.AcademicFacultyServices.createAcademicFaculty(req.body);
    res.status(200).json({
        success: true,
...
const updateAcademicFaculty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const data = req.body;
    const result = yield academicFaculty_service_1.AcademicFacultyServices.updateAcademicFaculty(id, data);
    res.status(200).json({
        success: true,
