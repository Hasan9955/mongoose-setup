...
exports.AcademicDepartControllers = void 0;
...
const getAcademicDepartments = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicDepartment_service_1.AcademicDepartmentServices.getAcademicDepartments();
    res.status(200).json({
        success: true,
...
const getSingleAcademicDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicDepartment_service_1.AcademicDepartmentServices.getSingleAcademicDepartment(req.params.id);
    res.status(200).json({
        success: true,
...
const updateAcademicDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = req.body;
    const result = yield academicDepartment_service_1.AcademicDepartmentServices.updateAcademicDepartment(id, data);
    res.status(200).json({
        success: true,
...
exports.AcademicDepartControllers = {
